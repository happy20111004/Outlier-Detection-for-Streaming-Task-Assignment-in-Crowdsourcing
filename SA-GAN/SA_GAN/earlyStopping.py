...
class EarlyStopping:
    ...
    def __call__(self, val_loss, model_G, model_D_rec, model_D_lat):
        ...
        if self.best_score is None:
            ...
            self.save_checkpoint(val_loss, model_G, model_D_rec, model_D_lat, self.opt.update_method, self.opt.sample_method)
    ...
    def save_checkpoint(self, val_loss, model_G, model_D_rec, model_D_lat, update_method, sample_method):
